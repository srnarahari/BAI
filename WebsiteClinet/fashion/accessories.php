...
<?php   
   ...
   $page_names = array("all"=>"all.php","exhibitions"=>"exhibitions.php","designer spotlight"=>"designer-spotlight.php","runway"=>"runway.php","style guide"=>"style-guide.php","accessories"=>"accessories.php","calendar"=>"calendar.php","slideshows"=>"slideshows.php");
    ...
    /** array = list of parameter for under menu links **/
      $all_parameter_Array = array($Lifestyle_Jewelry_Watches_true,$Fashion_Exhibitions_true,$Fashion_Designer_Spotlight_true,$Fashion_Runway_true,$Fashion_Style_Guide_true,$Fashion_Accessories_true); 
    /** array = list of parameter for under menu links **/
?>

<div class="container">
<h2><?php if($current_page == 'Accessories'):
      echo $current_page; ;
      else: 
      echo  $current_page;
      endif;
