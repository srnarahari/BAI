...
<?php   
    ...
    /** under menu pages **/
    $page_names = array("people"=>"people.php","destinations"=>"destinations.php","events"=>"events.php","photos"=>"photos.php","slideshows"=>"slideshows.php","themes"=>"themes.php","venues"=>"venues.php");
    /** under menu pages **/

    /** array = list of parameter for under menu links **/
      $all_parameter_Array = array($Travel_People_true,$Travel_Destinations_true,$Travel_Events_true,$Travel_Photos_true,$Travel_Slideshows_true,$Travel_Themes_true,$Travel_Venues_true); 
    /** array = list of parameter for under menu links **/
?>
<div class="container">
