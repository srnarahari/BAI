...
<nav class="navbar navbar-default">
  ...
  <?php foreach($page_names as $page_key => $page_name): ?>
      <li class="<?php if($page_key == $current_page){ echo 'active'; } ?>"><a href="<?php echo $path ?>visual-arts/<?php echo $page_key.'/'.$page_name; ?>"><?php echo $page_key; ?></a></li>
  <?php endforeach; ?>
  </ul>
</nav>
...
<?php
	...
	foreach($itemsList as $venues_data_key => $venues_li)
	{
		...
		echo "<li class='col-lg-4 no-padding'><a class='venue_name' href='$venues_li->_id;'>".$venues_li->entityName."</a><p class='venue_location'>(".$venues_city.")</p></li>";	
	}
?>
</ul>
</div>
