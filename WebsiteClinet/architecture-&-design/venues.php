...
<?php 
  ...
  /** under menu pages **/
       $page_names =  array("all"=>"architecture-&-design.php","architecture"=>"architecture.php","design"=>"design.php","home & interiors"=>"home-&-interiors.php","venues"=>"venues.php","calendar"=>"calendar.php","slideshows"=>"slideshows/all.php");
  /** under menu pages **/
...
<?php
  ...
  foreach($itemsList as $venues_data_key => $venues_li)
  {
    ...
    echo "<li class='col-lg-4 no-padding'><a class='venue_name' href='$path/venues/overview.php?id=$venues_li->_id'>".$venues_li->entityName."</a><p class='venue_location'>(".$venues_city.")</p></li>"; 
  }
?>
</ul>
</div>
