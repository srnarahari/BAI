...
<?php //echo '<pre>'; print_r($venues_data[1]);echo '</pre>'; ?>
<?php 
...
<div class="container no-padding pa_film">
	<div class="col-lg-7 no-padding pa_sec_one_left">
		<div class="main-image">
			<a href="<?php echo $current_url.'venues_detail.php?id='.getId($venues_data[0]); ?>">
				<?php getUpdloadedFiles($venues_data[0],'main'); ?>
			</a>		
		</div>
	...
	<div class="col-lg-5 no-padding pa_sec_one_right">
		...
		<div class="col-lg-12 no-padding pa-rgt-grid">
			<div class="col-lg-6 no-padding">
				...
				<p class="title">
				<a href="<?php echo $current_url.'news.php?id='.getId($topgrid); ?>"><?php echo getEntityName($topgrid); ?></a></p>
