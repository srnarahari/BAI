...
<?php //echo '<pre>'; print_r($articleArray[0]);echo '</pre>'; ?>
<?php 	
		...
		$all_parameter_Array = array($VA_Reviews_All,$VA_Reviews_Antiquities_true,$VA_Reviews_Contemporary_true,$VA_Reviews_Impressionism_true,$VA_Reviews_Old_Masters_true,$VA_Reviews_Traditional_true);	
		/** array = list of parameter for under menu links **/
?>
<div class="container">
...
<ul class="nav navbar-nav">
  <?php 
    ...
    <li class="<?php if($page_key == $current_page){ echo 'active';}?>">
      	<a href="<?php echo $path ?>visual-arts/reviews/<?php echo $page_name.$all_parameter_Array[$page_param_count]; ?>"><?php echo $page_key; ?></a>
    </li>
  <?php 
		$page_param_count++;
		endforeach; 
...
<div class="container no-padding pa_film">
	<div class="col-lg-7 no-padding pa_sec_one_left">
		...
		<div class="main-image-title">
			<h4 class="pa_category"><?php echo gettopCategrory($articleArray[0]); ?></h4>
	...
	<div class="col-lg-5 no-padding pa_sec_one_right">
		...
		<div class="col-lg-12 no-padding pa-rgt-grid">
			<div class="col-lg-6 no-padding">
				<p class="pa_category"><a href="#"><?php echo gettopCategrory($topgrid); ?></a></p>
				<p class="title">
...
<div class="row no-padding pa_list_film">
	...
	<div class="col-lg-12 no-padding pa_list_film_grid">
			...
			<div class="col-lg-8">
				<p class="pa_category"><?php echo gettopCategrory($grid); ?></p>
