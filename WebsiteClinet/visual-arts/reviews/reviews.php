...
<?php   
    ...
    $all_parameter_Array = array($Reviews_true,$VA_Reviews_Antiquities_true,$VA_Reviews_Contemporary_true,$VA_Reviews_Impressionism_true,$VA_Reviews_Old_Masters_true,$VA_Reviews_Traditional_true);  
    /** array = list of parameter for under menu links **/
?>
<div class="container">
