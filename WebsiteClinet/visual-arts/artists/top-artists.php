...
<div class="col-lg-12 no-padding most-popular-top-artist-section">
	...
	<div class="five-artists">
			<a href="<?php echo $path; ?>visual-arts/artists/artist_overview.php?id=<?php echo $artists->_id?>">
				<?php getArtistImage($artists,'thumbnail'); ?>
			</a>
			<span></span>
			<h5><?php echo $artists->artistName; ?></h5>
			<h6><?php echo substr($artists->articleDescription,0,67);?>
			<a class="more" href="<?php echo $path; ?>artists/all-artists.php">...more</a>
			</h6>
	</div>
	<?php 	$i++;
			endif;	
...
<div class="col-lg-12 no-padding most-popular-top-artist-section">
	...
	?>
	<div class="five-artists">
		<a href="<?php echo $path; ?>artists/artist_overview.php?id=<?php echo $artists->_id?>">
			<?php getArtistImage($artists,'thumbnail'); ?>
        </a>
		<span></span>
		<h5><?php echo $artists->artistName; ?></h5>
		<h6><?php echo substr($artists->articleDescription,0,67);?>
		<a class="more" href="<?php echo $artist->_id; ?>">...more</a>
		</h6>
	</div>
	<?php   endforeach; ?>		
</div>
