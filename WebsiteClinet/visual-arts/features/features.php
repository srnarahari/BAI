...
<?php   
    ...
    /** under menu pages **/
    $page_names = array("all"=>"all.php","news"=>"news.php","art market news"=>"art-market-news.php","reviews"=>"reviews.php","auctions"=>"auctions.php","fairs"=>"fairs.php","galleries"=>"galleries.php","museums"=>"museums.php","features"=>"features.php","artists"=>"artists.php","venues"=>"venues.php","calendar"=>"calendar.php","slideshows"=>"slideshows.php","art prices"=>"art-prices.php");
    /** under menu pages **/

    /** array = list of parameter for under menu links **/
    $all_parameter_Array = array($all_visual_arts,$news_true,$art_market_news_true,$reviews_true,$auctions_true,$fairs_true,$galleries_true,$nuseums_true,$features_true,$artists_true,$venues_true,$calendar_true,$slideshows_true,$art_prices_true); 
    /** array = list of parameter for under menu links **/
?>
<div class="container">
...
<ul class="nav navbar-nav">
  <?php 
    ...
    <li class="<?php if($page_key == $current_page){ echo 'active';}?>">
        <a href="<?php echo $path ?>visual-arts/<?php echo $page_key.'/'.$page_name.$all_parameter_Array[$page_param_count]; ?>"><?php echo $page_key; ?></a>
    </li>
  <?php 
    $page_param_count++;
    endforeach; 
