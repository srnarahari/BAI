...
/* page name demo data*/
  ...
  $current_page = "all";
  $page_names = array("all"=>"all.php","news"=>"news.php","art market news"=>"art-market-news.php","reviews"=>"reviews.php","auctions"=>"auctions.php","fairs"=>"fairs.php","galleries"=>"galleries.php","museums"=>"museums.php","featuers"=>"featuers.php","artists"=>"artists.php","venues"=>"venues.php","calender"=>"calender.php","slideshows"=>"slideshows.php","art prices"=>"art-prices.php");
