...
<div class="col-lg-12 no-padding artwork-secton-2">
    ...
    <?php foreach($page_names as $page_key => $page_name): ?>
      <li class="<?php if($page_key == 'overview'){ echo 'active'; } ?>"><a href="<?php echo $path ?>visual-arts/artists/<?php echo $page_name."?=".$artistDatas[0]->_id; ?>"><?php echo $page_key; ?></a></li>
    <?php endforeach; ?>
    </ul>
  	</nav>
...
<?php $auction_result_data = getSalesArtistData(); 
      $artist_lot_articles = $auction_result_data->lot;
