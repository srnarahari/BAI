...
function postUserId(){
	...
	var url="http://localhost:7005/api/v1/website/article/getarticleById/<?php echo $article_id; ?>";
	var userID = localStorage.getItem('bai_subscriber_userid');
	var token = localStorage.getItem('bai_subscriber_token');
	...
	<div class="single artist-details">
		...
		<div class="container inner_page_life_style">
			...
			<div class="single-grids">
				<div class="col-lg-offset-1 col-lg-10 col-md-offset-1 col-md-12 no-padding">
            ...
            <div class="col-lg-offset-2 col-lg-8 no-padding content-center artist_body capitalize">
                <!-- sai -->
                    <h2 class="capitalize" style="display: none;"><?php echo getParaHeader($Article_Article_array); ?></h2>
                    <p class="capitalize" ><?php echo getArticleBody($Article_Article_array); ?></p>
                    <h5 class="uppercase" style="text-align: center;">TO READ THE FULL STORY</h5>
                    <!-- <input type="button" value ='SUBSCRIBE' style="background-color: #00b1f4;;border: none;color: white;padding: 15px 44px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 340px;cursor: pointer;">
                    <input type="button" value ='SUBSCRIBE' style="background-color: white;color: black;padding: 15px 44px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 340px;cursor: pointer;"> -->
                    <center>
                        <a href="<?php echo $path; ?>subscriber\checkout.php"><input type="submit" style="background-color: #00b1f4;border: none;color: white;padding: 10px 88px; text-align: center;text-decoration: none;display: inline-block;font-size: 14px;margin: 4px 34px;cursor: pointer;" name="action" value="SUBSCRIBE" /></a>
                        <a href="<?php echo $path; ?>subscriber/login.php"><input type="submit" name="action" style="background-color: white;color: black;padding: 10px 88px;font-size: 14px;" value="SIGN IN" /></a>
                    </center>
                <!-- sai -->
