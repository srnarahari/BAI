...
@Component({
  selector: 'app-microsite-edit-events',
  templateUrl: './microsite-edit-events.component.html',
  styleUrls: ['./microsite-edit-events.component.scss']
})
export class MicrositeEditEventsComponent implements OnInit {
...
onEdit(item){
  ...
  this._router.navigateByUrl(`/layout/microsite-events/${item._id}`)
}
